...
public class ChatServer extends JFrame {
    ...
    // The deployment uses Cloudflare's supported HTTPS origin port 8443.
    // Keep this configurable through ssl-config.json.
    ...
    static final String DEFAULT_MIN_CLIENT_VERSION = "3.0.5";
